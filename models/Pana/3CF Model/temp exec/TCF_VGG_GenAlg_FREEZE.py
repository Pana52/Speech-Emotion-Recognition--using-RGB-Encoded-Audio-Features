...
def main():
    ...
    feature_model = VGG16(weights='imagenet', include_top=False, input_shape=(*IMAGE_SIZE, 3))
    ...
    with open(f"CNN_{IMAGE_SUBFOLDER}_{DATASET}_{MODEL}_{MODE}_optimization_results.txt", "w") as output_file:
