...
def build_feature_extractor():
    base_model = VGG16(weights='imagenet', include_top=False, input_shape=(*IMAGE_SIZE, 3))  # Using VGG16
...
def train_and_evaluate(feature_model, hyperparams, features, labels):
    ...
    model = build_classification_model(NUM_CLASSES, (512,), hyperparams)
