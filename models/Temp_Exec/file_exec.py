...
# Example file list
files_to_execute = ["TCF_ResNet_GenAlg_FREEZE_01.py",
                    "TCF_ResNet_GenAlg_FREEZE_02.py",
                    "TCF_ResNet_GenAlg_FREEZE_03.py",
                    "TCF_ResNet_GenAlg_FREEZE_04.py",
                    "TCF_ResNet_GenAlg_FREEZE_05.py",
                    "TCF_ResNet_GenAlg_FREEZE_06.py",
                    ]
